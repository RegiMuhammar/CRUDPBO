      ...
      <div class="container">
        ...
        <form method="POST" action="proses.php" class="font-weight-bold">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="nim" class="form-control" id="Nim" placeholder="contoh: 21051214042" required value="<?php echo $nim; ?>">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="namamhs" class="form-control" id="Namamhs" placeholder="contoh: Regi Muhammar" required value="<?php echo $namamhs; ?>">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text"  name="alamat" class="form-control" id="Alamat" placeholder="Contoh: Jalan Ketintang Wiyata 1 No. 8" required value="<?php echo $alamat; ?>">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <input type="email" name="email" class="form-control" id="Email" placeholder="contoh: regimuhammar@gmail.com" required value="<?php echo $email; ?>">
                </div>
            </div>
